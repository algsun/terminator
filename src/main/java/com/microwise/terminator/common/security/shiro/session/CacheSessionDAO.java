 ...
 */
package com.microwise.terminator.common.security.shiro.session;
...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO {
    ...
    protected void doUpdate(Session session) {
        ...
        if (request != null) {
            ...
            // 如果是视图文件，则不更新SESSION
            if (StringUtils.startsWith(uri, thymeleafProperties.getPrefix())
                    && StringUtils.endsWith(uri, thymeleafProperties.getSuffix())) {
                return;
            }
            // 手动控制不更新SESSION
