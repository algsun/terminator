...
import com.microwise.terminator.common.utils.Exceptions;
...
public class LogUtils {
     ...
     * 保存日志
     */
    public static void saveLog(HttpServletRequest request, Object handler, Exception exception, String title) {
    ...
    public static String getMenuNamePath(String requestUri, String permission) {
        String href = StringUtils.substringAfter(requestUri, "/terminator");
